...
#define MAX_CONV_INPUT MAX_INPUT_CHANNELS*MAX_INPUT_DIMS*MAX_INPUT_WIDTH*MAX_INPUT_HEIGHT*MAX_BATCH
#define MAX_CONV_OUTPUT MAX_OUTPUT_CHANNELS*MAX_OUTPUT_DIMS*MAX_OUTPUT_WIDTH*MAX_OUTPUT_HEIGHT*MAX_BATCH
