...
input_var = Variable(torch.randn(1, 1, 8 , 16, 16))
...
b = biases_var.numpy()
output_var = nn.functional.conv_transpose3d(input_var,filter_var,bias=biases_var,stride=2, padding=2, dilation=1)
