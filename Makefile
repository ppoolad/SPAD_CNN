...
all_layer: all_test/* conv3d_test/* conv_trans3d_test/* util/*
	g++ total_vgg_test/*.cpp conv3d_test/conv3d_layer.cpp conv_test/hw_conv3d_layer.c conv_trans3d_test/conv_trans3d_layer.cpp conv_test/hw_conv_trans3d_layer.c util/*.cpp  -I all_test -I./ -o all_layer -std=c++11
