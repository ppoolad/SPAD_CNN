...
def parse_arguments(args):
    ...
    return opt
def myprocess_denoise(opt, model, middlebury_filename, out_filename):
    ...
    for i in tqdm(range(num_rows)):
        for j in range(0, num_cols, batchsize):
            ...
            print('shape {}'.format(denoise.shape))
            print('bi: {}, ei: {}'.format(begin_idx,end_idx))
        ...
        for noise_param in noise_params:
            ...
            for scene in opt['scene']:
                ...
                if opt['option'] == 'Upsample8xDenoise':
                    ...
                    myprocess_denoise(opt, model, middlebury_filename,
                                    out_filename)
